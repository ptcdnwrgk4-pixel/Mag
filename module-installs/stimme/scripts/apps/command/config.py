...
def load_config() -> Config:
    ...
    Note on Claude Agent SDK auth: this config does NOT load an ANTHROPIC_API_KEY.
    The Claude Agent SDK auto-discovers credentials from the Claude CLI's
    authenticated session (login via the `claude` CLI is required once).
    """
